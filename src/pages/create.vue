...
async function createCollection() {
  ...
  try {
    ...
    if (collectionForm.value.twitterUrl) {
      collectionData.metadata.twitter = collectionForm.value.twitterUrl;
    }

    if (collectionForm.value.discordUrl) {
      collectionData.metadata.discord = collectionForm.value.discordUrl;
    }
        ...
        <div class="mx-auto max-w-3xl">
          ...
          <div v-if="createMode === 'nft'" class="bg-gray-900/70 rounded-xl border border-purple-800/30 p-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-300 mb-1">Name (will be included in metadata)</label>
                <input v-model="nftForm.name" type="text" placeholder="Item name"
              ...
              <div>
                <label class="block text-sm font-medium text-gray-300 mb-1">Description (will be included in
                  metadata)</label>
                <textarea v-model="nftForm.description" rows="3"
              ...
              <div>
                ...
                <select v-model="nftForm.collectionSymbol"
                  ...
                  <option v-for="collection in nftCollections" :key="collection.symbol || collection.id"
                    :value="collection.symbol || collection.id">{{
              ...
              <div>
                ...
                <input v-model="nftForm.coverUrl" type="url" placeholder="https://example.com/image.png"
                  class="w-full px-4 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none">
              </div>
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div v-for="(property, index) in nftMetadata" :key="index" class="flex gap-2 items-center">
                    <input v-model="property.trait_type" type="text" placeholder="Trait Type (e.g., Color)"
                    ...
                    <input v-model="property.value" type="text" placeholder="Value (e.g., Blue)"
                      class="flex-1 rounded-lg px-4 py-2 border-2 border-purple-800/50 bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500">
                    <button v-if="nftMetadata.length > 1" @click="removeMetadata(index)"
                ...
                <button @click="addMetadata" type="button"
              ...
              <div class="pt-4">
                <button @click="createNFT" :disabled="loading"
            ...
            <div class="space-y-6">
              ...
              <div class="flex gap-6 items-start">
                ...
                <div class="w-2/3 space-y-4">
                  ...
                  <div>
                    ...
                    <input v-model="collectionForm.symbol" type="text" maxlength="10"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none"
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input v-model="collectionForm.maxSupply" type="number" min="1"
                        class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none"
                        placeholder="Leave empty for unlimited">
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-300 mb-1">Royalty (%)</label>
                      <input v-model="collectionForm.royaltyBps" type="number" min="0" max="25" step="0.1"
                        class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none"
                        placeholder="5.0">
                  ...
                  <div>
                    ...
                    <textarea v-model="collectionForm.description" rows="3" maxlength="1000"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none"
                  ...
                  <div>
                    ...
                    <input v-model="collectionForm.logoUrl" type="url"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none"
              ...
              <div class="pt-4 border-t border-gray-800">
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex items-center">
                    ...
                    <input v-model="collectionForm.websiteUrl" type="url" placeholder="https://yourwebsite.com"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none" />
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <input v-model="collectionForm.twitterUrl" type="url" placeholder="https://twitter.com/yourusername"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none" />
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <input v-model="collectionForm.discordUrl" type="url" placeholder="https://discord.gg/yourinvite"
                      class="w-full px-3 py-2 border-2 border-purple-800/50 focus:border-cyan-500 rounded-lg bg-gray-900/80 text-white placeholder-gray-500 focus:outline-none" />
                  </div>
                </div>
              </div>
              ...
              <div class="pt-4 border-t border-gray-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div class="flex items-center">
                    <input v-model="collectionForm.transferable" id="transferable" type="checkbox"
                  ...
                  <div class="flex items-center">
                    <input v-model="collectionForm.burnable" id="burnable" type="checkbox"
                      class="w-4 h-4 text-cyan-500 bg-gray-900 border-purple-800 rounded focus:ring-cyan-500 focus:ring-2">
                    <label for="burnable" class="ml-2 text-sm text-gray-300">Burnable</label>
                  </div>

                  <div class="flex items-center">
                    <input v-model="collectionForm.mintable" id="mintable" type="checkbox"
                      class="w-4 h-4 text-cyan-500 bg-gray-900 border-purple-800 rounded focus:ring-cyan-500 focus:ring-2">
