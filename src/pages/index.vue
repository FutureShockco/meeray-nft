        ...
        <div class="max-w-7xl mx-auto text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button @click="router.push('/create')"
              class="px-8 py-4 bg-gray-800 border border-cyan-500/30 text-white font-bold rounded-xl text-lg hover:bg-gray-700 transition-all">
              Create NFT
            </button>
                  </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto">
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">{{ stats.totalNFTs }}</div>
              <div class="text-gray-400">NFTs Created</div>
              </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-purple-400 mb-2">{{ stats.totalUsers }}</div>
              <div class="text-gray-400">Active Users</div>
                </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-green-400 mb-2">{{ stats.totalVolume }}</div>
              <div class="text-gray-400">STEEM Volume</div>
                  </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-orange-400 mb-2">{{ stats.totalCollections }}</div>
      ...
      <section class="py-16 px-4">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Featured Collections</h2>
            <p class="text-gray-400 text-lg">Discover the most popular NFT collections on our platform</p>
                </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div v-for="collection in featuredCollections" :key="collection.id"
              ...
              <div class="bg-gray-900 p-6 border-t-2 border-cyan-500">
                ...
                <p class="text-sm text-gray-400 mb-4">by <span class="text-cyan-400">{{ collection.creator }}</span></p>
          ...
          <div class="text-center mt-12">
            <button @click="router.push('/collections')"
              class="px-8 py-3 bg-gray-800 border border-cyan-500/30 text-white font-semibold rounded-xl hover:bg-gray-700 transition-all">
      ...
      <section class="py-16 px-4">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-12">
            ...
            <p class="text-gray-400 text-lg">Get started with NFTs in just a few simple steps</p>
                    </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
              ...
              <h3 class="text-xl font-bold text-white mb-2">1. Connect Wallet</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="text-xl font-bold text-white mb-2">2. Create or Browse</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="text-xl font-bold text-white mb-2">3. Trade & Earn</h3>
              <p class="text-gray-400">Buy, sell, and trade NFTs with other users on the marketplace</p>
                    </div>
                  </div>
                </div>
      </section>
      ...
      <section class="py-16 px-4">
        <div class="max-w-4xl mx-auto text-center">
          <div class="bg-gradient-to-r from-cyan-500/10 to-purple-600/10 rounded-2xl p-12 border border-cyan-500/20">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Start Your NFT Journey?</h2>
            <p class="text-gray-300 text-lg mb-8">Join thousands of creators and collectors on the premier Steem NFT marketplace</p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button @click="router.push('/create')"
                class="px-8 py-4 bg-transparent border-2 border-cyan-500 text-cyan-400 font-bold rounded-xl text-lg hover:bg-cyan-500 hover:text-white transition-all">
